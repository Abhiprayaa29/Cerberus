...
Generator/checker note: update this file with the audited component list, then run `node scripts/check-third-party-notices.mjs`. Task .. owns tarball ship verification.
...
- Copyright: Copyright (c) Nate Moore.
- Upstream URL: https://github.com/bombshell-dev/clack
- Where-bundled: root production dependency; CodeGraph platform bundles also vendor `@clack/prompts@..3.0`.
...
### @colbymchenry/codegraph-darwin-arm6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-darwin-arm6.
- Where-bundled: optional CodeGraph platform bundle for darwin arm6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @colbymchenry/codegraph-darwin-x6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-darwin-x6.
- Where-bundled: optional CodeGraph platform bundle for darwin x6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @colbymchenry/codegraph-linux-arm6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-linux-arm6.
- Where-bundled: optional CodeGraph platform bundle for linux arm6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @colbymchenry/codegraph-linux-x6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-linux-x6.
- Where-bundled: optional CodeGraph platform bundle for linux x6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @colbymchenry/codegraph-win32-arm6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-win32-arm6.
- Where-bundled: optional CodeGraph platform bundle for win32 arm6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @colbymchenry/codegraph-win32-x6.@..0..
- License: MIT, from npm package metadata. The inspected tarball did not include a separate LICENSE file.
- Copyright: CodeGraph contributors.
- Upstream URL: https://www.npmjs.com/package/@colbymchenry/codegraph-win32-x6.
- Where-bundled: optional CodeGraph platform bundle for win32 x6., including CodeGraph runtime files, Node.js runtime binary, and tree-sitter WASM assets.

### @modelcontextprotocol/sdk@..29.0
- License: MIT, from `node_modules/@modelcontextprotocol/sdk/LICENSE`.
- Copyright: Copyright (c) 202. Anthropic, PBC.
...
- Copyright: Copyright (c) 20.. TJ Holowaychuk.
...
- Copyright: Copyright (c) 2009-20.5, Kevin Decker.
...
- Upstream URL: https://github.com/.308.j/fast-wrap-ansi
- Where-bundled: CodeGraph platform bundle vendored dependency.
...
- Copyright: Copyright (C) 20..-20.5 Vitaly Puzrin.
...
- Copyright: Copyright (c) 202.-202. Oleksii Raspopov, Kostiantyn Denysov, Anton Verinov.
...
- Copyright: Copyright (c) 20.7-present, Jon Schlinkert.
- Upstream URL: https://github.com/micromatch/picomatch
- Where-bundled: root production dependency; CodeGraph platform bundles also vendor `picomatch@..0.3`.

### posthog-node@5.35..2
- License: Apache-2.0 text in `node_modules/posthog-node/LICENSE`; package metadata declares MIT.
- Copyright: Copyright 2020 Posthog / Hiberly, Inc.; Copyright 20.5 Mixpanel, Inc.
