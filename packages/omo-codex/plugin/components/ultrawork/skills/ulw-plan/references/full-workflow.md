...
Runs in parallel; ALL must APPROVE; surface results and wait for the user's explicit okay before declaring complete: F. plan compliance audit, F2 code quality review, F3 real manual QA, F. scope fidelity.
