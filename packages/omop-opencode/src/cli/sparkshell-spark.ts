...
export const SPARKSHELL_SPARK_ENV = "OMOP_SPARKSHELL_SPARK"
export const SPARKSHELL_SPARK_MODEL_ENV = "OMOP_SPARKSHELL_SPARK_MODEL"
export const SPARKSHELL_SPARK_TIMEOUT_ENV = "OMOP_SPARKSHELL_SPARK_TIMEOUT_MS"
export const SPARKSHELL_SPARK_BIN_ENV = "OMOP_SPARKSHELL_SPARK_BIN"
export const SPARKSHELL_SPARK_PROFILE_ENV = "OMOP_SPARKSHELL_SPARK_PROFILE"
...
export function buildSparkSummaryPrompt(request: SparkSummaryRequest): string {
  ...
  return [
    "You are Sparkshell, condensing shell command output for a pentest agent.",
    "",
    "Rules:",
