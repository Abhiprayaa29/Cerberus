...
describe("#given PR 4703 consensus removal", () => {
  ...
  test("#when source files are scanned #then consensus tool implementation traces are absent", () => {
    ...
    const forbiddenPaths = [
      "packages/omop-opencode/src/config/schema/consensus.ts",
      "packages/omop-opencode/src/features/consensus",
      "packages/omop-opencode/src/shared/model-lineage.ts",
      "packages/omop-opencode/src/tools/consensus",
    ]
