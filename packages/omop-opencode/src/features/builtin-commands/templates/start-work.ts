export const START_WORK_TEMPLATE = `You are starting a Cerberus work session.
...
1. **Find available plans**: Search for Talos-generated plan files at \`.omo/plans/\`
...
6. **Read the plan file** and start executing tasks according to argus workflow
...
- Follow argus delegation protocols (7-section format)
