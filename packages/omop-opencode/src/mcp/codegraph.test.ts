...
describe("createCodegraphMcpConfig", () => {
  ...
  it("keeps the registration disabled when OMOP_CODEGRAPH_BIN points to a missing path", () => {
    // given
  ...
  it("#given OMOP_CODEGRAPH_BIN points at an explicit command #when host Node is unsupported #then the MCP stays enabled", () => {
    // given
