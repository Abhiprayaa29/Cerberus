...
const ENV_MAPPINGS = [
	["auto_provision", "OMOP_CODEGRAPH_AUTO_PROVISION", "boolean"],
	["auto_provision", "CODEX_CODEGRAPH_AUTO_PROVISION", "boolean"],
	["enabled", "OMOP_CODEGRAPH_ENABLED", "boolean"],
	["enabled", "CODEX_CODEGRAPH_ENABLED", "boolean"],
	["install_dir", "OMOP_CODEGRAPH_INSTALL_DIR", "string"],
	["install_dir", "CODEX_CODEGRAPH_INSTALL_DIR", "string"],
	["telemetry", "OMOP_CODEGRAPH_TELEMETRY", "boolean"],
