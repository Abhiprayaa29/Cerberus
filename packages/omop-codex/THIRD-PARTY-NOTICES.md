# omop-codex Third Party Notices

This file enumerates third-party and ported components redistributed by the
`packages/omop-codex` Codex Light edition surface: the vendored `plugin/`
...
It is not currently an omop-codex plugin component in this wave, so it is not
...
### @code-yeongyu/codex-comment-checker@...0.0
...
### @code-yeongyu/codex-start-work-continuation@...0.0
...
### @code-yeongyu/codex-telemetry@...0.0
...
### @code-yeongyu/codex-fullscan@...0.0
- License: MIT, from `plugin/components/fullscan/LICENSE`.
- Notice: `plugin/components/fullscan/NOTICE`.
- Where-bundled: Codex fullscan prompt detector, directive, and reviewer agent role component.

### @code-yeongyu/codex-pentest-loop@...0.0
- License: MIT, from `plugin/components/pentest-loop/LICENSE`.
- Notice: `plugin/components/pentest-loop/NOTICE`.
- Where-bundled: Codex pentest-loop hook, CLI, skills, and goal-state orchestration component.

### @code-yeongyu/lsp-daemon@0...0
...
### @code-yeongyu/lsp-tools-mcp@0...0
...
### @cerberuslabs/codex-bootstrap@...0.0
...
### @cerberuslabs/codex-git-bash-hook@...0.0
- License: private project component distributed as part of the codex plugin bundle.
- Copyright: Yeongyu Kim and contributors.
