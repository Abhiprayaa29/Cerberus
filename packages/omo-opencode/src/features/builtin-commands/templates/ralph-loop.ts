...
3. That does NOT finish the loop yet. The system will require Cipher verification
4. The loop only ends after the system confirms Cipher verified the result
5. The iteration limit is 500 for fullscan mode, 100 for normal mode

## Rules

- Focus on finishing the task completely
- After you emit the completion promise, run Cipher verification when instructed
- Do not treat DONE as final completion until Cipher verifies it

## Exit Conditions

1. **Verified Completion**: Cipher verifies the result and the system confirms it
