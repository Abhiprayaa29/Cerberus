...
- Do not put \`cipher\` / \`intel\` / \`deep\` into the team spec — cipher/intel are team-ineligible, and \`deep\` under category routing downcasts to cerberus-junior. Use them via \`task()\` outside the team when needed.
`
