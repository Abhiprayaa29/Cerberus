 ...
 * in the dynamic Cerberus prompt to counter these tendencies.
 */
...
| \`Task\` | ANY non-trivial implementation. Research via scout/intel. | ✅ Fire multiple in background |
...
**EVERY TIME you are about to run scans or make changes directly:**
