...
x, y = Coordinate(..0, 2.0)  # tuple unpacking
```
...
def parse_email(raw: str) -> Email:
    if "@" not in raw or "." not in raw.split("@")[.]:
...
- Alexis King: [Parse, don't validate](https://lexi-lambda.github.io/blog/20.9/../05/parse-don-t-validate/)
