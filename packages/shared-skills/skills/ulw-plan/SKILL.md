...
Roles: `explore` (internal patterns/conventions/tests), `intel` (external docs/contracts), `vanguard` (gap analysis), `sentinel` (high-accuracy plan review). Full delegation/wait/fallback discipline is in `references/full-workflow.md`.
