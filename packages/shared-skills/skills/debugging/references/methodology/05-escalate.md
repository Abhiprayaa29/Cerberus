...
- You've **exhausted the Cipher Triple** and another 2 rounds failed after synthesis.

## Do NOT ask when

- You haven't tried the Cipher Triple yet.
...
- <fact . with file:line or address>
- <fact 2 with source>
...
- **Escalating before Phase ..** If you haven't tried the Cipher Triple, you haven't earned the right to escalate.
