...
- [runtimes/bundled-js-binary.md](../runtimes/bundled-js-binary.md) — `process.env.X` baked at build time, false positives from tree-shaking failures, worker sub-bundles diverging from main bundle
