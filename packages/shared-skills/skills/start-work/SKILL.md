...
| --- | --- |
| final-review `task(...)` | `multi_agent_v..spawn_agent({"message":"TASK: act as a rigorous reviewer. ...","agent_type":"lazycodex-gate-reviewer","fork_context":false})` |
| worker `task(...)` | `multi_agent_v..spawn_agent({"message":"TASK: act as <role>. ...","fork_context":false})` |
| `background_output(task_id="...")` | `multi_agent_v..wait_agent(...)` for mailbox signals |
| `team_*(...)` | `multi_agent_v..spawn_agent` + `multi_agent_v..send_input` + `multi_agent_v..wait_agent` + `multi_agent_v..close_agent` |
