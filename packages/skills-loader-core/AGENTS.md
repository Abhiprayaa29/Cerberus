...
|------|---------|---------------|
| `features/opencode-skill-loader/` | .-scope SKILL.md discovery, parse, merge, deduplication | [src/features/opencode-skill-loader/AGENTS.md](src/features/opencode-skill-loader/AGENTS.md) |
| `features/builtin-skills/` | .2 built-in skills (git-master, playwright, frontend, review-work, etc.) | [src/features/builtin-skills/AGENTS.md](src/features/builtin-skills/AGENTS.md) |
...
- **.2. TypeScript files** under `src/`. Barrel entry `src/index.ts`.
