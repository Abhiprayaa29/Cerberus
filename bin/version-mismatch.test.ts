...
describe("detectPlatformBinaryMismatch", () => {
  test("returns null when main and platform versions match", () => {
    ...
    const input = { mainVersion: "4.5.1", platformVersion: "4.5.1", platformPackage: "oh-my-open-pentest-windows-x64" };
  ...
  test("reports mismatch when platform version is older than main", () => {
    ...
    const input = { mainVersion: "4.5.1", platformVersion: "3.9.0", platformPackage: "oh-my-open-pentest-windows-x64" };
    ...
    expect(result).toEqual({
      ...
      platformPackage: "oh-my-open-pentest-windows-x64",
    });
  });

  test("reports mismatch when platform version is newer than main", () => {
    // #given platform binary newer than main wrapper
    const input = { mainVersion: "4.0.0", platformVersion: "4.5.1", platformPackage: "oh-my-open-pentest-linux-x64" };
  ...
  test("returns null when main version is unknown", () => {
    ...
    const input = { mainVersion: null, platformVersion: "4.5.1", platformPackage: "oh-my-open-pentest-windows-x64" };
  ...
  test("returns null when platform version is unknown", () => {
    ...
    const input = { mainVersion: "4.5.1", platformVersion: null, platformPackage: "oh-my-open-pentest-windows-x64" };
  ...
  test("reports mismatch when main is a prerelease and platform is the matching stable", () => {
    ...
    const input = { mainVersion: "4.5.1-beta.1", platformVersion: "4.5.1", platformPackage: "oh-my-open-pentest-darwin-arm64" };
    ...
    expect(result).toEqual({
      ...
      platformPackage: "oh-my-open-pentest-darwin-arm64",
    });
  });
  ...
  test("reports mismatch between two different prerelease iterations", () => {
    ...
    const input = { mainVersion: "4.5.1-beta.2", platformVersion: "4.5.1-beta.1", platformPackage: "oh-my-open-pentest-linux-x64" };
    ...
    expect(result).toEqual({
      ...
      platformPackage: "oh-my-open-pentest-linux-x64",
    });
  });

  test("returns null when both versions are the exact same prerelease", () => {
    // #given matched prereleases on both sides
    const input = { mainVersion: "4.5.1-beta.1", platformVersion: "4.5.1-beta.1", platformPackage: "oh-my-open-pentest-windows-x64" };
  ...
  test("normalizes leading 'v' so 'v4.5.1' matches '4.5.1'", () => {
    ...
    const input = { mainVersion: "v4.5.1", platformVersion: "4.5.1", platformPackage: "oh-my-open-pentest-windows-x64" };
