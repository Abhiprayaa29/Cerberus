...
**Oh My Open Pentest** is a powerful OpenCode plugin that transforms your AI agent into a full development team:

- 🤖 **Multi-Agent Orchestration**: Cipher (GPT-5.5), Intel (Claude), Scout (Grok), Frontend Engineer (Gemini), and more
...
🔗 **GitHub**: https://github.com/code-yeongyu/oh-my-open-pentest
